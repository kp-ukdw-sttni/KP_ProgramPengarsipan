            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6 border-b pb-4">
                        <h3 class="text-lg font-medium text-gray-900">{{ __('Formulir Pengarsipan Dokumen Baru') }}</h3>
                    ...
                    <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nomor_arsip" class="block mt-1 w-full" type="text" name="nomor_arsip" :value="old('nomor_arsip')" required autofocus />
                            ...
                            <div class="mt-4">
                                ...
                                <select id="kategori_id" name="kategori_id" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full bg-white text-gray-900" required>
                                    <option value="" disabled selected>{{ __('Select Kategori') }}</option>
                            ...
                            <div class="mt-4">
                                ...
                                <select id="divisi_id" name="divisi_id" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full bg-white text-gray-900" required>
                                    ...
                                    @else
                                        <option value="" disabled selected>{{ __('Select Divisi') }}</option>
                                        @foreach($divisi as $d)
                            ...
                            <!-- File Upload -->
                            <div class="mt-4">
                                <x-input-label for="file" :value="__('File Dokumen (PDF, JPG, PNG - Max 10MB)')" />
                                <x-text-input id="file" class="block mt-1 w-full border border-gray-300 p-2" type="file" name="file" accept=".pdf,.jpg,.jpeg,.png" required />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="retention_date" class="block mt-1 w-full" type="date" name="retention_date" :value="old('retention_date')" required />
                                <small class="text-xs text-gray-500 mt-1 block">{{ __('Setelah melewati tanggal ini, status arsip otomatis beralih ke Expired.') }}</small>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="deskripsi" name="deskripsi" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full bg-white text-gray-900" rows="4" placeholder="{{ __('Tuliskan deskripsi singkat dokumen di sini...') }}">{{ old('deskripsi') }}</textarea>
